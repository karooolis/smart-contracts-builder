...
const formSchema = z.object({
  ...
  abi: z.string().min(2, {
    message: "abi must be at least 2 characters. f",
  }),
...
export function SimulatorForm() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      address: "0x904eF98751C82f77b7B66765E393Fa0c84DAfC2f", // "0xd0e1065f2a941dd723f800c34d2d4282c3158a00",
  ...
  const onSubmit = async () => {
    ...
    const args = functionInputs.length > 0 ? values.inputs : [];
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="mt-10 w-[568px] space-y-8 rounded-md border p-4"
      >
        <FormField
